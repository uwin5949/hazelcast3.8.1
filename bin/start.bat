...
set "CLASSPATH=%~dp0..\lib\hazelcast-all-3.8.1.jar;C:\DeviceHive\devicehive-java-server\devicehive-common\target\devicehive-common-3.5.0-shade.jar"
...
set "JAVA_OPTS=%JAVA_OPTS% -cp C:\DeviceHive\devicehive-java-server\devicehive-common\target\devicehive-common-3.5.0-shade.jar;C:\DeviceHive\hazelcast-3.8.1\lib\hazelcast-all-3.8.1.jar"
